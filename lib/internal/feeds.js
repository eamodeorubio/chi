...
module.exports = {
  ...
  stateFactoryWith:function (bus, yieldingNotificationType) {

  },
  initialStateFor:function (pluginName, bus, yieldNotificationType, opts) {
    return this.plugins[pluginName](this.yieldingState(bus, yieldNotificationType, this), this.stateFactoryWith(bus, yieldNotificationType), opts);
  },
