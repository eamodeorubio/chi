...
function FiringYieldEventsState(bus) {
  this.yield = function (value) {
    bus.fire('yield', value);
    return this;
  };
  this.throw = function (error) {
...
function PublishingYieldEventsState(bus) {
  this.yield = function (value) {
...
module.exports.emitter = function () {
  ...
  return new Feed(bus, new FiringYieldEventsState(bus));
};

module.exports.list = function () {
  var bus = new utils.EventBus();
  return new Feed(bus, new PublishingYieldEventsState(bus));
};