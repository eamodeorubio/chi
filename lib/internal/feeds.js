...
var self = module.exports = {
  ...
  yieldingState:function (bus, yieldNotificationType, optFactory) {
    return new YieldingState(bus, yieldNotificationType, optFactory ? optFactory : self);
  },
  ...
  initialStateFor:function (pluginName, bus, yieldNotificationType, opts) {
    var outputState = self.yieldingState(bus, yieldNotificationType, self);
    return self.plugins[pluginName](outputState, self.stateFactoryWith(outputState), opts);
  },
