...
module.exports = {
  ...
  stateFactoryWith:function (outputState) {
    var plugins = this.plugins;
    return function factory(pluginName, opts) {
      return plugins[pluginName](outputState, factory, opts);
    };
  },
  initialStateFor:function (pluginName, bus, yieldNotificationType, opts) {
    var outputState = this.yieldingState(bus, yieldNotificationType, this);
    return this.plugins[pluginName](outputState, this.stateFactoryWith(outputState), opts);
  },
